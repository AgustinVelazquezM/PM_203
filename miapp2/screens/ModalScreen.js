    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.card}>
                ...
                <Text style={styles.cardText}>Duracion: 80 minutos</Text>
            ...
            <Pressable style={styles.primaryButton} onPress={() => setModalVisible(true)}>
                <Text style={styles.primaryButtonText}>Confirmar reservarción</Text>
            </Pressable>
            ...
            >
                <View style={styles.overlay}>
                    <View style={styles.modalCard}>
                        <Text style={styles.modalTitle}>Confirmar reservarvación</Text>
                        <Text style={styles.modalText}>
                            ¿Estás seguro de que deseas reservar la clase en modalidad {selectedMode}?
                        </Text>
...
const styles = StyleSheet.create({
    ...
    primaryButtonText: { color: '#f2f2ed', fontSize: 16, fontWeight: '700' },
    secondaryButton: {
    ...
    modalCard: { width: '100%', backgroundColor: '#ffffff', borderRadius: 30, padding: 22 },
    modalTitle: { fontSize: 22, fontWeight: '700', color: '#18202f', marginBottom: 50 },
